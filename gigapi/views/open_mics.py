...
class OpenMicSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = OpenMic
        fields = ['id', 'user', 'event_title', 'recurrence', 'weekly_recurrence', 'monthly_recurrence', 'start_time', 'end_time', 'event_image', 'is_owner']

class OpenMicWriteSerializer(serializers.ModelSerializer):
    
    class Meta:
        model = OpenMic
        fields = ['user', 'event_title', 'recurrence', 'weekly_recurrence', 'monthly_recurrence', 'start_time', 'end_time', 'event_image']


class OpenMicViewSet(viewsets.ViewSet):

    def list(self, request):
        open_mics = OpenMic.objects.all()
